      ...
      <div className="section-container">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-muted">
            <span>&copy; {currentYear} Setthapong Pomrung.</span>
          ...
          <div className="flex items-center gap-3">
            <a href="https://github.com/Setthapong18" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-primary-600 transition-colors cursor-pointer" aria-label="GitHub">
            ...
            <a href="mailto:setthapongc@gmail.com" className="text-muted hover:text-primary-600 transition-colors cursor-pointer" aria-label="Email">
